        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    ...
                    <form method="GET" action="{{ route('almacenes.index') }}" class="d-inline-block w-100">
                        <div class="row">
                            <div class="col-md-10">
                                <input type="text" name="query" class="form-control" placeholder="Número, Capacidad o Tipo" value="{{ $query ?? '' }}">
                            </div>
                            <div class="col-md-2">
